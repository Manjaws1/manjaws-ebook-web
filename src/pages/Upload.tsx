...
const UploadPage = () => {
  ...
  const [uploadedBooks, setUploadedBooks] = useState(sampleBooks);
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      // Add the new book to our sample library with a generated ID
      const newBook = {
        id: (uploadedBooks.length + 1).toString(),
        title: data.title,
        author: data.author,
        coverImage: coverPreview || "https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=1374&auto=format&fit=crop",
      ...
      setActiveTab('library'); // Switch to library view after successful upload
    } catch (error) {
      toast({
        variant: "destructive",
        title: "Error",
      ...
      <main className="flex-grow py-10 bg-gray-50">
        <div className="container max-w-3xl">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold mb-2">eBook Management</h1>
            <p className="text-gray-600">Upload and manage your eBooks in one place</p>
                ...
                <CardContent>
                  ...
                  {uploadedBooks.length === 0 && (
                    <div className="text-center py-12">
                      <p className="text-gray-500">Your library is empty. Upload your first eBook!</p>
                      <Button 
                        className="mt-4" 
                        onClick={() => setActiveTab('upload')}
                      >
